...
class AudioProvider with ChangeNotifier {
  ...
  String _audioFormat = 'm4a'; // AGREGADO: 'm4a', 'aac', 'mp3'
  ...
  String get audioFormat => _audioFormat; // AGREGADO
  ...
  /// AGREGADO: Establecer formato de audio
  void setAudioFormat(String format) {
    if (!_isRecording && ['m4a', 'aac', 'mp3'].contains(format)) {
      _audioFormat = format;
      notifyListeners();
      debugPrint('🎵 Formato de audio: ${format.toUpperCase()}');
    }
  }
